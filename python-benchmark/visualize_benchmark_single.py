...
def visualize_output(env, params, corridors, planner_methods, 
    ...
    fig_folder = 'python-benchmark/files/single/figs/'
...
files = ["python-benchmark/files/single/single_case_P2P.json",
         "python-benchmark/files/single/single_case_OCP.json",
         "python-benchmark/files/single/single_case_ARENA.json"]
