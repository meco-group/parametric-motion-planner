...
class Trajectory{
    public:
        ...
        const std::vector<double>& Px() const { return px_;};
        const std::vector<double>& Py() const { return py_;};
        ...
        void GetBoundingBox(int start_idx, int stop_idx, Corridor& box) const;
