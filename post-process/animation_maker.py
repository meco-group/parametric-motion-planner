...
def make_animation(folder_path, appendix):
    ...
    # keep only every other STEP_SIZE frame
    png_files = png_files[::STEP_SIZE]
    ...
    images[0].save(output_path, save_all=True, append_images=images[1:], duration=STEP_SIZE*DT*1000, loop=0)
